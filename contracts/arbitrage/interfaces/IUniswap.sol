...
abstract contract IUniswapExchange {
    ...
    function removeLiquidity(
        ...
        uint256 min_tokens,
        uint256 deadline
    ) virtual external returns (uint256, uint256);
    ...
    function ethToTokenTransferInput(
        ...
        uint256 deadline,
        address recipient
    ) virtual external payable returns (uint256 tokens_bought);
    ...
    function ethToTokenTransferOutput(
        ...
        uint256 deadline,
        address recipient
    ) virtual external payable returns (uint256 eth_sold);
    ...
    function tokenToEthSwapInput(
        ...
        uint256 min_eth,
        uint256 deadline
    ) virtual external returns (uint256 eth_bought);
    ...
    function tokenToTokenSwapInput(
        ...
        uint256 deadline,
        address token_addr
    ) virtual external returns (uint256 tokens_bought);
